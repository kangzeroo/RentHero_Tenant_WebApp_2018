...
class LocationDialog extends Component {
  ...
  redrawContainer(duration = 500) {
	...
	render() {
		return (
			<div id='LocationDialog' onClick={() => this.props.toggleInstantCharsSegmentID(this.shown_segments[this.shown_segments.length - 1].id)} style={comStyles().container}>
...
const RadiumHOC = Radium(LocationDialog)
