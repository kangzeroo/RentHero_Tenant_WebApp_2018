...
FINANCIALS = {
  ...
  InputSegment              2. whats your name?

  PhoneOrEmailRegister      2. What is your phone number?

  DatePickerSegment         4. What is your ideal movein date?
  ...
  ActionSegment              5. Thanks for your application! The property manager will review your application and be in contact shortly.
                                        a. Would you like to browse for more properties similar to this?

  MapSegment                 6. Where do you most often commute to?

  MultiOptionsSegment        7. How do you travel?

  InputSegment               8. What is your budget per person?

  ActionSegment              9. Ready to see your matches?
