...
class AmenitiesDialog extends Component {
  ...
  redrawContainer(duration = 500) {
	...
	render() {
		return (
			<div id='AmenitiesDialog' onClick={() => this.props.toggleInstantCharsSegmentID(this.shown_segments[this.shown_segments.length - 1].id)} style={comStyles().container}>
...
AmenitiesDialog.defaultProps = {

}

// Wrap the prop in Radium to allow JS styling
const RadiumHOC = Radium(AmenitiesDialog)
