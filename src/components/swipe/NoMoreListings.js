// Compt for copying as a NoMoreListings
...
class NoMoreListings extends Component {
	...
	render() {
		return (
			<div id='NoMoreListings' style={comStyles().container}>
        <div onClick={() => this.instantCharClick()} style={comStyles().scroll}>
					...
					<div id='middle_part' style={comStyles().middle_part}>
						<div id='section_one' style={comStyles().sectional}>
							<SubtitlesMachine
									...
									text={`That's all your matches! Check back tommorrow for more listings, or adjust your search preferences for more options.`}
									textStyles={{
										fontSize: '1.1rem',
										color: 'white',
										textAlign: 'left',
                ...
                <div style={comStyles().field_holder}>
                  <div style={travelStyles().listDiv}>
                    <div onClick={() => this.props.history.push('/prefs')} style={travelStyles().driving}>UPDATE SEARCH</div>
                    <div onClick={() => this.props.history.push('/favourites')} style={travelStyles().transit}>MY FAVOURITES</div>
                  </div>
                </div>
								:
								null
...
NoMoreListings.propTypes = {
	history: PropTypes.object.isRequired,
}

// for all optional props, define a default value
NoMoreListings.defaultProps = {

}

// Wrap the prop in Radium to allow JS styling
const RadiumHOC = Radium(NoMoreListings)
