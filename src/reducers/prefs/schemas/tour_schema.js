...
export const TOUR = {
    ...
    HAS_REALTOR_AS: '',                                  // save as CSV string
    HAS_REALTOR_AS_SCHEMAS: [],                            // save as stringified json
    ...
    WHY_NO_REALTOR_AS: '',                                                 // save as CSV string
    WHY_NO_REALTOR_AS_SCHEMAS: [],                            // save as stringified json
    ...
    TOUR_APPROX_AVAIL_AS: '',                                  // save as CSV string
    TOUR_APPROX_AVAIL_AS_SCHEMAS: [],                           // save as stringified json
    ...
    TOUR_SPECIFIC_AVAIL_AS: '',                                                 // save as CSV string
    TOUR_SPECIFIC_AVAIL_AS_SCHEMAS: [],                      // save as stringified json
    ...
    CAN_DRIVE_TOURS_AS: '',                                  // save as CSV string
    CAN_DRIVE_TOURS_AS_SCHEMAS: [],                            // save as stringified json
