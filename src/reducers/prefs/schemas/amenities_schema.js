...
export const AMENITIES = {
    ...
    // MIN_SQFT: 900,
    SIZE_PREF_AS: '',                   // save as CSV string
    SIZE_PREF_AS_SCHEMAS: [],                                // save as stringified json
    MIN_SQFT: 500,
    ...
    UTILTIES_INCL_AS: '',                                  // save as CSV string
    UTILTIES_INCL_AS_SCHEMAS: [],                            // save as stringified json
    ...
    PRIVATE_BATH_AS: '',                                         // save as CSV string
    PRIVATE_BATH_AS_SCHEMAS: [],                            // save as stringified json
    ...
    PARKING_SPOTS_AS: '',                                 // save as CSV string
    PARKING_SPOTS_AS_SCHEMAS: [],                            // save as stringified json
    PARKING_SPOTS_REQUIRED: 0,
    ...
    UNIT_AMENITIES_AS: '',                           // save as CSV string
    UNIT_AMENITIES_AS_SCHEMAS: [],                         // save as stringified json
    ...
    BUILDING_AMENITIES_AS: '',                           // save as CSV string
    BUILDING_AMENITIES_AS_SCHEMAS: [],                         // save as stringified json
